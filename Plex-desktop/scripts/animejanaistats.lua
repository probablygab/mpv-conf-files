...
function show_animejanai_stats()
    if showingMessage then
        ...
        if mp.get_property("vf") == "" then
            ...
            local data_file_path = (mp.command_native({'expand-path', "C:/Program Files/Plex/Plex/animejanai/core/currentanimejanai.log"}))
...
mp.add_key_binding("z", "show_animejanai_stats", show_animejanai_stats)